...
<html lang="en">
    <head>
        ...
        <script src="VectorBattle_UI_font.typeface.js"></script>
        <style>
            body {
                margin: 0;
                display: flex;
        ...
        <div id="game_canvas" style="display: flex; justify-content: center; align-items: center;">
            <div id="game-container">
                ...
                <div id="instructions">
                    <p>Controls:</p>
                    <ul>
                        <li><b>Left/Right Arrows:</b> Rotate the ship</li>
        ...
        <script>
            ...
            Sprite = function () {
                ...
                this.draw = function () {
                    ...
                    this.context.strokeStyle = 'white'; // Set stroke color to white
                    this.context.fillStyle = 'white';   // Set fill color to white (if filling shapes)
            ...
            function updateDatabase() {
                ...
                const params = 'game_name=Asteroids&user_id=' + <?php echo $userID?> +'&score=' + Game.score;
